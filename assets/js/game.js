...
var wordBank = ['giants', 'ravens', 'seahawks', 'patriots', 'broncos', 'clemson', 'alabama', 'ohio state', 'florida state', 'astros', 'cubs', 'royals', 'giants', 'red sox', 'warriors', 'cavaliers', 'spurs', 'heat', 'north carolina', 'villanova', 'duke', 'connecticut', 'louisville'];
//Holds choosenWord
var choosenWord = "";
...
function winLose() 
{
	...
	else if(guessesLeft === 0)
	{
		...
		//Changes HTML
		document.getElementById('lossCounter').innerHTML = loseCount;
		alert('Nobody remembers 2nd place');
		reset();
	}
}
